...
<asp:textbox id=txtUser Width="250px" runat="server"></asp:textbox></TD>
    <TD width="25%">
<asp:requiredfieldvalidator id=rfvUser Runat="server" ErrorMessage="Campo Necessário" ControlToValidate="txtUser"></asp:requiredfieldvalidator></TD></TR>
  <TR>
    <TD></TD>
...
<asp:textbox id=txtPassword Width="250px" runat="server" TextMode="Password"></asp:textbox></TD>
    <TD>
<asp:requiredfieldvalidator id=rfvPassword Runat="server" ErrorMessage="Campo Necessário" ControlToValidate="txtPassword"></asp:requiredfieldvalidator></TD></TR>
  <TR>
    <TD></TD>
...
<asp:textbox id=txtConfirmaPassword Width="250px" runat="server" TextMode="Password"></asp:textbox></TD>
    <TD>
<asp:requiredfieldvalidator id=rfvConfirmaPassword Runat="server" ErrorMessage="Campo Necessário" ControlToValidate="txtConfirmaPassword"></asp:requiredfieldvalidator></TD></TR>
  <TR>
    <TD></TD>
...
<asp:textbox id=txtEmail Width="250px" runat="server"></asp:textbox></TD>
    <TD>
<asp:requiredfieldvalidator id=rfvEmail Runat="server" ErrorMessage="Campo Necessário" ControlToValidate="txtEmail"></asp:requiredfieldvalidator></TD></TR>
  <TR>
    <TD></TD>
...
<asp:textbox id=txtNome Width="250px" runat="server"></asp:textbox></TD>
    <TD>
<asp:requiredfieldvalidator id=rfvNome Runat="server" ErrorMessage="Campo Necessário" ControlToValidate="txtNome"></asp:requiredfieldvalidator></TD></TR>
  <TR>
    <TD></TD>
...
<asp:textbox id=txtPais Width="250px" runat="server"></asp:textbox></TD>
  ...
  <TR>
    ...
    <TD></TD>
    <TD colSpan=2>
<asp:CompareValidator id=CompareValidator runat="server" ErrorMessage="As passwords não são iguais, confirme novamente!" ControlToValidate="txtConfirmaPassword" ControlToCompare="txtPassword"></asp:CompareValidator><BR>
<asp:Label id=lblMensagem runat="server" ForeColor="Red"></asp:Label></TD></TR></TABLE>
<P></P>
<DIV align=center><FONT color=#ff0000>*</FONT> - Campo Obrigatório</DIV>
<DIV align=center><BR>
...
servidor!</B><BR><BR>Vai ser redireccionado para a área privada onde poderá 
publicar informação relativamente à sua empresa e alterar os dados publicados. 
Caso o redireccionamento não ocorra automáticamente pode carregar <A class=link 
href="../Administrar/login.aspx?origem=publicar">aqui.</A> </P>
<P class=textoNormal>Não se esqueça de ver o correio electrónico para proceder à 
activação da sua conta, para ter acesso à área privada.</P><BR>
		</asp:panel>
		<DIV align="center">
			<table width="100%">
