<%@ Page language="c#" Codebehind="zona.aspx.cs" AutoEventWireup="false" Inherits="SiSTPortal.zona" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		...
		<table width="100%" border="0" cellSpacing="0" cellPadding="0">
			...
			<tr>
				<td width="22%" bgcolor="#b0c4de" align="middle"><b><font color="#ffffff" face="Arial, Helvetica, sans-serif">Opções</font></b></td>
				<td>&nbsp;</td>
