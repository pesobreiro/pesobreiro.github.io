...
namespace SiSTUddi.pesquisa
{
	...
	/// UDDI.
	/// </summary>
	public class PesquisaAvancada : System.Web.UI.Page
	{
		...
		{    
			this.rbParametrosPesquisa.SelectedIndexChanged += new System.EventHandler(this.rbParametrosPesquisa_SelectedIndexChanged);
		...
		private void rbParametrosPesquisa_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			if (rbParametrosPesquisa.SelectedItem.Value.ToString()=="prod")
			{
				this.pnlRegistrarServico.Visible = true;
				this.txtNome.Visible = false;
