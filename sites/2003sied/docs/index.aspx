...
<HTML>
	<HEAD>
		<TITLE>Sistema para Integração de Serviços para Turismo</TITLE>
	...
	<BODY>
		<TABLE width="100%" border="0">
			<TR>
				...
				<td valign="center" align="center"><p>
						<a href="../SiSTUDDI/Administrar/login.aspx?origem=administrar" class="link">Administração</a><br>
		...
		<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<TR>
				<TD width="22%" bgcolor="#b0c4de" align="middle"><B><FONT color="#ffffff" face="Arial, Helvetica, sans-serif">Opções</FONT></B>
				</TD>
				<TD>
				</TD>
			</TR>
			<TR>
				...
				<TD valign="top">
					<P class="texto">
						...
						<a href="#oqueumservicoweb" class="link">O que é um serviço web?</a><BR>
					</P>
				</TD>
			</TR>
			<TR>
				<TD bgcolor="#ffffff" valign="top">
					<TABLE width="212" border="0" cellspacing="0" cellpadding="0" bgcolor="#e2e2e2">
						...
						<TR>
							...
							<TD>
								<DIV align="center"><A href="" class="link">Oferta Turística</A>
								</DIV>
							</TD>
							<TD>&nbsp;
							</TD>
						...
						<TR>
							...
							<TD>
								<DIV align="center"><A href="" class="link">Opções Avançadas</A>
								</DIV>
							</TD>
							<TD>&nbsp;
							</TD>
					...
					<TABLE width="212" border="0" cellspacing="0" cellpadding="0" bgcolor="#e2e2e2">
						...
						<TR>
							...
							<TD><A href="../zona.aspx?id=distritos-pt:Acores" class="link">Açores</A>
							</TD>
						...
						<TR>
							...
							<TD><A href="../zona.aspx?id=distritos-pt:Braganca" class="link">Bragança</A>
							</TD>
						...
						<TR>
							...
							<TD><A href="../zona.aspx?id=distritos-pt:Santarem" class="link">Santarém</A>
							</TD>
						</TR>
						<TR>
							<TD>&nbsp;
							...
							<TD><A href="../zona.aspx?id=distritos-pt:Setubal" class="link">Setúbal</A>
							</TD>
						</TR>
						<TR>
							<TD>&nbsp;
							</TD>
							<TD><A href="../zona.aspx?id=distritos-pt:Evora" class="link">Évora</A>
							</TD>
