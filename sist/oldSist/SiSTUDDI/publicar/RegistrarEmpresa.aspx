...
<HTML>
	...
	<BODY> <!--#include file="../include/topoPublicar.inc"--><asp:panel id="pnlConteudo" runat="server" Width="100%" HorizontalAlign="Center" Visible="False">
												...
												<DIV align="center">
													...
													<TABLE id="tableEmpresa" cellSpacing="1" cellPadding="1" width="100%" border="0">
														<TR>
															<TD width="20%">Nome:</TD>
															<TD width="75%">
																<asp:TextBox id="txtNome" Width="330px" runat="server"></asp:TextBox>
														...
														<TR>
															...
															<TD>
																<asp:TextBox id="txtDescricao" Width="330px" runat="server"></asp:TextBox>
														...
														<TR>
															...
															<TD>
																<asp:TextBox id="txtContacto" Width="330px" runat="server"></asp:TextBox>
														...
														<TR>
															...
															<TD>
																<asp:TextBox id="txtFuncaoContacto" Width="330px" runat="server"></asp:TextBox>
