							...
							<P align="justify">
								<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="300" align="center" border="0">
									<TR>
										...
										<TD>
											<P align="center">
												<asp:textbox id="txtUsername" runat="server" Width="175px" Font-Size="X-Small" Font-Names="Verdana" BorderStyle="Solid"></asp:textbox></P>
										</TD>
									</TR>
									<TR>
										<TD width="125"></TD>
										<TD>
											<P align="center">
												<asp:requiredfieldvalidator id="RequiredFieldValidator1" runat="server" Font-Size="X-Small" ErrorMessage="Campo necessário!" Display="Dynamic" ControlToValidate="txtUsername"></asp:requiredfieldvalidator></P>
										</TD>
									</TR>
									<TR>
										...
										<TD>
											<P align="center">
												<asp:textbox id="txtPassword" runat="server" Width="175px" Font-Size="X-Small" Font-Names="Verdana" BorderStyle="Solid" CssClass="link" TextMode="Password"></asp:textbox></P>
										</TD>
									</TR>
									<TR>
										<TD width="125"></TD>
										<TD>
											<P align="center">
												<asp:requiredfieldvalidator id="Requiredfieldvalidator2" runat="server" Font-Size="X-Small" ErrorMessage="Campo Necessário!" Display="Dynamic" ControlToValidate="txtPassword"></asp:requiredfieldvalidator></P>
										</TD>
									</TR>
									<TR>
										<TD width="125"></TD>
									...
									<TR>
										...
										<TD>
											<P align="center">
												<asp:Label id="lblLogin" runat="server" Font-Size="X-Small" ForeColor="Red" Visible="False">Nome utilizador ou password inválida</asp:Label>
												<asp:Label id="lblConta" runat="server" Font-Size="X-Small" ForeColor="Red" Visible="False">A sua conta está desactivada</asp:Label></P>
										</TD>
									</TR>
								</TABLE>
							</P>
