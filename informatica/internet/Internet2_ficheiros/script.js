...
var ENDSHOW_MESG="Fim da apresentação. Faça clique para sair.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=22, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   ...
   new hrefList("slide0065.htm", 1, 2),
   new hrefList("slide0042.htm", 1, 3),
   new hrefList("slide0066.htm", 1, 4),
   new hrefList("slide0104.htm", 1, 5),
   new hrefList("slide0102.htm", 1, 6),
   new hrefList("slide0126.htm", 1, 7),
   new hrefList("slide0130.htm", 1, 8),
   new hrefList("slide0067.htm", 1, 9),
   new hrefList("slide0092.htm", 1, 10),
   new hrefList("slide0091.htm", 1, 11),
   ...
   new hrefList("slide0085.htm", 1, 16),
   new hrefList("slide0125.htm", 1, 17),
   new hrefList("slide0127.htm", 1, 18),
   new hrefList("slide0132.htm", 1, 19),
   new hrefList("slide0128.htm", 1, 20),
