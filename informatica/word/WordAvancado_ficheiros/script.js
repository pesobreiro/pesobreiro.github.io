...
var ENDSHOW_MESG="Fim da apresentação. Faça clique para sair.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=44, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   ...
   new hrefList("slide0063.htm", 1, 8),
   new hrefList("slide0064.htm", 1, 9),
   new hrefList("slide0065.htm", 1, 10),
   new hrefList("slide0066.htm", 1, 11),
   new hrefList("slide0067.htm", 1, 12),
   new hrefList("slide0069.htm", 1, 13),
   new hrefList("slide0070.htm", 1, 14),
   new hrefList("slide0050.htm", 1, 15),
   ...
   new hrefList("slide0073.htm", 1, 24),
   ...
   new hrefList("slide0061.htm", 1, 29),
   new hrefList("slide0052.htm", 1, 30),
   new hrefList("slide0034.htm", 1, 31),
   new hrefList("slide0075.htm", 1, 32),
   new hrefList("slide0076.htm", 1, 33),
   new hrefList("slide0043.htm", 1, 34),
   new hrefList("slide0077.htm", 1, 35),
   ...
   new hrefList("slide0084.htm", 1, 40),
   new hrefList("slide0083.htm", 1, 41),
   new hrefList("slide0085.htm", 1, 42),
