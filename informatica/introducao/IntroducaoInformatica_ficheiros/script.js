...
var ENDSHOW_MESG="Fim da apresentação. Faça clique para sair.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=21, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   new hrefList("slide0287.htm", 1, 1),
   new hrefList("slide0281.htm", 1, 2),
   new hrefList("slide0294.htm", 1, 3),
   new hrefList("slide0295.htm", 1, 4),
   new hrefList("slide0296.htm", 1, 5),
   new hrefList("slide0288.htm", 1, 6),
   new hrefList("slide0293.htm", 1, 7),
   new hrefList("slide0292.htm", 1, 8),
   new hrefList("slide0291.htm", 1, 9),
   new hrefList("slide0290.htm", 1, 10),
   new hrefList("slide0297.htm", 1, 11),
   new hrefList("slide0298.htm", 1, 12),
   new hrefList("slide0299.htm", 1, 13),
   new hrefList("slide0300.htm", 1, 14),
   new hrefList("slide0301.htm", 1, 15),
   new hrefList("slide0302.htm", 1, 16),
   new hrefList("slide0303.htm", 1, 17),
   new hrefList("slide0304.htm", 1, 18),
   new hrefList("slide0305.htm", 1, 19),
   new hrefList("slide0306.htm", 1, 20),
   new hrefList("slide0307.htm", 1, 21)
);
