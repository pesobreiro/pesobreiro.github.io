...
var ENDSHOW_MESG="Fim da apresentação. Faça clique para sair.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=60, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   ...
   new hrefList("slide0041.htm", 1, 4),
   new hrefList("slide0042.htm", 1, 5),
   new hrefList("slide0043.htm", 1, 6),
   new hrefList("slide0045.htm", 1, 7),
   new hrefList("slide0046.htm", 1, 8),
   new hrefList("slide0047.htm", 1, 9),
   new hrefList("slide0055.htm", 1, 10),
   new hrefList("slide0049.htm", 1, 11),
   new hrefList("slide0050.htm", 1, 12),
   new hrefList("slide0051.htm", 1, 13),
   new hrefList("slide0071.htm", 1, 14),
   new hrefList("slide0070.htm", 1, 15),
   new hrefList("slide0064.htm", 1, 16),
   new hrefList("slide0065.htm", 1, 17),
   new hrefList("slide0066.htm", 1, 18),
   new hrefList("slide0067.htm", 1, 19),
   new hrefList("slide0069.htm", 1, 20),
   new hrefList("slide0062.htm", 1, 21),
   new hrefList("slide0059.htm", 1, 22),
   new hrefList("slide0056.htm", 1, 23),
   new hrefList("slide0021.htm", 1, 24),
   new hrefList("slide0063.htm", 1, 25),
   new hrefList("slide0018.htm", 1, 26),
   ...
   new hrefList("slide0036.htm", 1, 33),
   new hrefList("slide0037.htm", 1, 34),
   new hrefList("slide0038.htm", 1, 35),
   new hrefList("slide0039.htm", 1, 36),
   new hrefList("slide0040.htm", 1, 37),
   new hrefList("slide0072.htm", 1, 38),
   ...
   new hrefList("slide0025.htm", 1, 43),
   new hrefList("slide0024.htm", 1, 44),
   new hrefList("slide0083.htm", 1, 45),
   new hrefList("slide0084.htm", 1, 46),
   new hrefList("slide0091.htm", 1, 47),
   new hrefList("slide0085.htm", 1, 48),
   new hrefList("slide0090.htm", 1, 49),
   new hrefList("slide0086.htm", 1, 50),
   new hrefList("slide0088.htm", 1, 51),
   new hrefList("slide0098.htm", 1, 52),
   new hrefList("slide0101.htm", 1, 53),
   new hrefList("slide0102.htm", 1, 54),
   new hrefList("slide0099.htm", 1, 55),
   new hrefList("slide0081.htm", 1, 56),
   new hrefList("slide0082.htm", 1, 57),
   new hrefList("slide0092.htm", 1, 58),
   new hrefList("slide0061.htm", 1, 59),
   new hrefList("slide0068.htm", 1, 60)
);
...
var sNext="Seguinte",sPrev="Anterior",sEnd="Concluir apresentação",sFont="Arial"
function ShowMenu()
{
	BuildMenu();
